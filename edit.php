...
<form action="update.php" method="POST">
  ...
  <?php
    ...
    echo"<input type='text' placeholder='Apellido' name='paterno' value='{$row['apellido']}' required>";
    echo"<input type='text' placeholder='Segundo Apellido' name='materno' value='{$row['fecha_nacimiento']}' required>";
      echo"<label><b>Correo Electrónico</b>";
       echo"<input type='text' name='correo' value='{$row['Correo_electronico']}'required>";
    echo"</label>";
